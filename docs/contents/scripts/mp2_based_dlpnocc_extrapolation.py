...
def run_mp2_based_dlpnocc_extrapolation(structure: Structure, wd: Path = Path("RUN")):
    ...
    corr_energy_dlpno_mp2 = dlpno_mp2_out.get_energies()[EnergyType.MP2].correlation_energy
    corr_energy_ri_mp2 = ri_mp2_out.get_energies()[EnergyType.MP2].correlation_energy
