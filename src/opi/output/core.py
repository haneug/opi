...
class Output:
    ...
    def get_fcidump(self) -> Fcidump | None:
        """
        Parses a fcidump file generated by ORCA and return its data in the `Fcidump` data class.
        ORCA can generate fcidump files via the `dumpactints true` flag in the `%casscf` block.
        ...
        return Fcidump.parse_fcidump(fci_path)
